...
public class LogTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileInputStream inputStream = new FileInputStream("/Users/ZhaoZezhong/develop/work/customize-1.dic");
        ...
        FileWriter writer = new FileWriter("/Users/ZhaoZezhong/develop/work/customize-2.dic", true);
        for (String s1 : set) {
